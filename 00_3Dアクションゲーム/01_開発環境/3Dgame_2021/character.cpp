...
bool CCharacter::AttackCollision(void)
{
					...
					m_fWeaponRadius, pCharacter->m_fRadius) == true)
				{
					if (pCharacter->m_state != STATE_DAMAGE)
					{
						...
						CEffectFactory::CreateEffect(D3DXVECTOR3(
							this->m_apModelAnime.at(m_nWeaponTipNum)->GetMtxWorld()._41,
							this->m_apModelAnime.at(m_nWeaponTipNum)->GetMtxWorld()._42,
							this->m_apModelAnime.at(m_nWeaponTipNum)->GetMtxWorld()._43),
	...
	case CHARACTER_TYPE_ENEMY:
	{
		...
		D3DXVECTOR3 WorldPos = D3DXVECTOR3(
			...
			m_apModelAnime.at(m_nWeaponTipNum)->GetMtxWorld()._42,
			m_apModelAnime.at(m_nWeaponTipNum)->GetMtxWorld()._43);
